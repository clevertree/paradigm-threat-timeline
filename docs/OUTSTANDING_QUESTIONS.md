...
Unresolved questions, contradictions, and clarifications needed for the Alternate Earth History Timeline.
...
- **Source citations**: Many events lack explicit citations. Add where possible.
- **Priority assignment**: Events with `dates: []` (context sections) need rules for timeline placement.
- **Media array**: When to populate `media` vs rely on images embedded in markdown?
- **Scan paradigm-threat-files**: Governance, influence, events, science folders not yet fully extracted. Systematic scan needed.
