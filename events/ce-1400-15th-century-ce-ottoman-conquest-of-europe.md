...
<figure className="sm:float-left clear-left m-auto sm:m-1 sm:mr-4 sm:max-w-sm">
  <video title="Predictive Programming for Children: Conan the Barbarian finds Star Metal" poster="https://paradigm-threat.s3.amazonaws.com/video/thumb/Predictive+Programming:+Conan+The+Adventurer+Star+Metal.png" controls className="m-auto w-[384px] h-[288px]" >
    <source src="https://paradigm-threat.s3.amazonaws.com/video/Predictive+Programming:+Conan+The+Adventurer+Star+Metal.mp4" type="video/mp4"/>
  </video>
  <figcaption>
