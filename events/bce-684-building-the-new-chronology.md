...
The roughly 1700-year period alleged to have existed between end of cataclysm date of 684 B.C.E. and the beginning
of human history in the 11th century C.E. **is a complete fabrication** by agents of the *Holy Roman[ov] Empire*.
How was this determined? Between the 16th century and 19th centuries, various authors have written on
...
happened to agree that there were no flaws in the Scaligarian version of modern history.
...
![Anatoly Timofeevich Fomenko is a Soviet and Russian historical theorist, mathematician, professor at Moscow State
  University, well-known as a topologist, and a member of the Russian Academy of Sciences](https://clevertree.github.io/paradigm-threat-files/history/chronology/anatoly_fomenko.jpg?w=384)
...
<figure className="sm:float-right clear-right m-auto sm:m-1 sm:ml-4 sm:max-w-sm">
  <video title="Phantom Time Hypothesis" poster="https://paradigm-threat.s3.amazonaws.com/video/thumb/Phantom+Time+Hypothesis.png" controls className="m-auto w-[384px] h-[570px]" >
    <source src="https://paradigm-threat.s3.amazonaws.com/video/Phantom+Time+Hypothesis.mp4" type="video/mp4"/>
  </video>
  <figcaption>
    The [Phantom Time Hypothesis](https://en.wikipedia.org/wiki/Phantom_time_conspiracy_theory)
    ...
    *AD1053*. Both Catholics like St Jerome and Protestants like Joseph Scaliger are accused of opportunistically
    reappropriating actual African, Asian, and American history into a false European history sometime within the last
    500 years.
  </figcaption>
</figure>
