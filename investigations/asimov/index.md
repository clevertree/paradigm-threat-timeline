...
**Status:** Open  
**Purpose:** Study Asimov's literature for clues relevant to the timeline — predictive programming, empire collapse, AI/robotics, psychohistory, encoding of real history or suppressed knowledge.
...
- [01 Biography and Context](01-biography-and-context.md) — Life, Russian roots, Philadelphia Navy Yard, DARPA, institutional connections
- [02 Bibliography and Major Works](02-bibliography-and-major-works.md) — Foundation, Robots, Multivac, key short stories
- [03 Themes for Timeline Study](03-themes-for-timeline-study.md) — Predictive programming, empire collapse, psychohistory, encoding angles
- [full/foundation-index.md](full/foundation-index.md) — **Clue index** for the Foundation Trilogy (`foundation.txt`)
- [full/magnificent-possession-index.md](full/magnificent-possession-index.md) — **Clue index** for "The Magnificent Possession" (1940): discovery suppression, corporate interference
...
- Wikipedia: [Isaac Asimov](https://en.wikipedia.org/wiki/Isaac_Asimov), [Foundation series](https://en.wikipedia.org/wiki/Foundation_series), [Robot series](https://en.wikipedia.org/wiki/Robot_series_(Asimov))
- ISFDB: [Isaac Asimov bibliography](https://www.isfdb.org/cgi-bin/ea.cgi?5)
- Asimov Online: [Robot & Foundation history](https://www.asimovonline.com/oldsite/Robot_Foundation_history_1.html)
