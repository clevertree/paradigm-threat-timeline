# Remote Viewing / Remote Control in Fiction — Master Index
...
1. A **device or mechanism** enables perception of / communication with another world, dimension, or time period
2. The connection is often **two-way** — the other side can see/influence us
...
- (b) Multiple authors drawing on the same source tradition (occult, Hermetic, Masonic), or
- (c) **Predictive programming** — encoding real capability as fiction
...
### H.P. Lovecraft (104 stories + 2 essays)
- **Source:** hplovecraft.com
- **HTML originals:** `/home/ari/dev/wget/lovecraft/fiction/` and `essays/`
- **Clean text:** `/home/ari/dev/wget/lovecraft/txt/` and `txt-essays/`
- **Index:** `/home/ari/dev/wget/lovecraft/index-lovecraft.md`

### H.G. Wells
- **Source:** Project Gutenberg
- *Tales of Space and Time* (1899) — contains "The Crystal Egg": `/home/ari/dev/wget/wells/tales-of-space-and-time.txt`
- *The Country of the Blind and Other Stories* (1911) — contains "The Plattner Story", "The Crystal Egg" reprint, others: `/home/ari/dev/wget/wells/country-of-the-blind-and-other-stories.txt`

### Arthur Machen
- **Source:** Project Gutenberg
- *The Great God Pan* (1894): `/home/ari/dev/wget/machen/the-great-god-pan.txt`
- *The House of Souls* (1906): `/home/ari/dev/wget/machen/the-house-of-souls.txt`
- *The Three Impostors* (1895): `/home/ari/dev/wget/machen/the-three-impostors.txt`
- *The Terror* (1917): `/home/ari/dev/wget/machen/the-terror.txt`
- *The Hill of Dreams* (1907): `/home/ari/dev/wget/machen/the-hill-of-dreams.txt`
- *The Angels of Mons* (1915): `/home/ari/dev/wget/machen/the-angels-of-mons.txt`

### Algernon Blackwood
- **Source:** Project Gutenberg
- *The Willows* (1907): `/home/ari/dev/wget/blackwood/the-willows.txt`
- *John Silence, Physician Extraordinary* (1908): `/home/ari/dev/wget/blackwood/john-silence.txt`
- *Three John Silence Stories*: `/home/ari/dev/wget/blackwood/three-john-silence-stories.txt`

### Robert W. Chambers
- **Source:** Project Gutenberg
- *The King in Yellow* (1895): `/home/ari/dev/wget/other-refs/the-king-in-yellow-chambers.txt`

### Edward Bulwer-Lytton
- **Source:** Project Gutenberg
- *The Coming Race* (1871): `/home/ari/dev/wget/other-refs/the-coming-race-bulwer-lytton.txt`

### Lord Dunsany
- **Source:** Project Gutenberg
- *The Gods of Pegana* (1905): `/home/ari/dev/wget/other-refs/gods-of-pegana-dunsany.txt`

---

## Key Quotes by Theme

### 1. Crystal / Stone as Viewing Device

**Wells, "The Crystal Egg" (1899):**
...
### 2. Machine / Technology for Dimensional Perception
...
> *"That gland [pineal] is the great sense-organ of organs—I have found out."*
> *"In these rays we are able to be seen as well as to see."*
...
### 3. Mind Transfer / Consciousness Displacement

**Lovecraft, "The Shadow out of Time" (1936):**
> *"With suitable mechanical aid a mind would project itself forward in time... seize on the best discoverable representative of the highest of that period's life-forms; entering the organism's brain and setting up therein its own vibrations."*
...
### 4. Art / Text as Mind-Control Vector
...
> *"It is well known how the book spread like an infectious disease, from city to city, from continent to continent."*

### 5. Entities Perceiving Us Through the Veil
...
### 6. Underground Civilization with Vril-like Power

**Bulwer-Lytton, "The Coming Race" (1871):**
> *"By one operation of vril... they can influence the variations of temperature... they can exercise influence over minds, and bodies animal and vegetable, to an extent not surpassed in the romances of our mystics."*
> *"In the bowels of the inner earth... might be discovered the remains of human habitation—not in huts and caverns, but in vast cities whose ruins attest the civilisation of races which flourished before the age of Noah."*
...
- **Timeline article:** [Predictive Programming: Fiction as Control](/timeline/evt-predictive-programming-fiction-as-control)
- **War of the Worlds analysis:** `wget/text/wotw.md` and related files
- **Saturnian Cosmology sources:** `wget/saturniancosmology.org/`
- **Thunderbolts sources:** `wget/thunderbolts.info/`

## Not Yet Downloaded (Future Work)

- **Tolkien** — Palantíri (Silmarillion, Lord of the Rings) — still under copyright
- **John Dee** — obsidian scrying mirror (1580s) — historical, not fiction
- **Bulwer-Lytton** — *Zanoni* (1842) — Rosicrucian initiation novel, Gutenberg has it
- **Algernon Blackwood** — *The Centaur* (1911) — cosmic consciousness
- **William Hope Hodgson** — *The House on the Borderland* (1908) — dimensional leakage
- **Clark Ashton Smith** — Lovecraft's contemporary, extensive cosmic fiction
- **Abraham Merritt** — *The Moon Pool* (1919), *The Metal Monster* (1920)
- **M.R. James** — ghost stories with antiquarian scrying themes
- **Arthur Conan Doyle** — *The Land of Mist* (1926), spiritualist fiction
- **Edward Bellamy** — *Looking Backward* (1888) — future-viewing
- **Camille Flammarion** — *Lumen* (1887) — cosmic consciousness, time perception
