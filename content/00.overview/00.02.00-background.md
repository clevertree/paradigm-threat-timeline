...
Challenging the established scientific timeline of Earth's history is not a recent development.
...
of conspiring to obfuscate historical records before the 13th century C.E. In modern times, state-sponsored historian
[Anatoly Fomenko](https://en.wikipedia.org/wiki/Anatoly_Fomenko#Historical_revisionism)
used [statistical analysis](https://chronologia.org/en/math_impressions/index.html) of published records
from 2,200 sources including [Scaliger](https://en.wikipedia.org/wiki/Joseph_Justus_Scaliger),
...
His team revealed **duplicated** chronology spanning periods of hundreds or thousands of years, often with names and locations changed. In his [New Chronology](https://en.wikipedia.org/wiki/New_chronology_\(Fomenko\)),
...
In 1952, [Immanuel Velikovsky](https://en.wikipedia.org/wiki/Immanuel_Velikovsky) posited that 'ancient' history needed a [major revision](https://en.wikipedia.org/wiki/Ages_in_Chaos). Using
[comparative mythology](https://en.wikipedia.org/wiki/Comparative_mythology) and ancient literary sources
(especially the Old Testament), he argued that Earth suffered catastrophic close contacts with other planets
...
theory providing a new foundation in interplanetary physics that explained why these cataclysms occurred.
In [Saturnian Cosmology](https://www.plasmacosmology.net/myth.html), Earth's recorded history is **less than 4 thousand years** since the start
...
making corrections. I'm hoping this project helps others navigate the _dissonance of consensus_ and access the *unredacted* origin story of our planet and species. This timeline focuses on *causality* between major events (why one event led to the next), so not all events of world history are listed.
